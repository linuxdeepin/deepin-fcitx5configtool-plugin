...
class IntegerOptionWidget : public OptionWidget {
    Q_OBJECT
public:
    IntegerOptionWidget(const fcitx::FcitxQtConfigOption &option, const QString &path,
                        QWidget *parent)
...
class StringOptionWidget : public OptionWidget {
    Q_OBJECT
public:
    StringOptionWidget(const fcitx::FcitxQtConfigOption &option, const QString &path,
                       QWidget *parent)
...
class FontOptionWidget : public OptionWidget {
    Q_OBJECT
public:
    FontOptionWidget(const fcitx::FcitxQtConfigOption &option, const QString &path,
                     QWidget *parent)
...
class BooleanOptionWidget : public OptionWidget {
    Q_OBJECT
public:
    BooleanOptionWidget(const fcitx::FcitxQtConfigOption &option, const QString &path,
                        QWidget *parent)
...
class KeyListOptionWidget : public OptionWidget {
    Q_OBJECT
public:
    KeyListOptionWidget(const fcitx::FcitxQtConfigOption &option, const QString &path,
                        QWidget *parent)
...
private:
    QList<fcitx::Key> readValue(const QVariantMap &map, const QString &path) {
        ...
        while (true) {
            ...
            keys << fcitx::Key(value.toUtf8().constData());
            i++;
        }
        return keys;
    }
...
class KeyOptionWidget : public OptionWidget {
    Q_OBJECT
public:
    KeyOptionWidget(const fcitx::FcitxQtConfigOption &option, const QString &path,
                    QWidget *parent)
        : OptionWidget(path, parent),
          keyWidget_(new fcitx::FcitxQtKeySequenceWidget(this)),
          defaultValue_(
        ...
        connect(keyWidget_, &fcitx::FcitxQtKeySequenceWidget::keySequenceChanged, this,
                &OptionWidget::valueChanged);
    ...
    void readValueFrom(const QVariantMap &map) override {
        fcitx::Key key;
        auto value = readString(map, path());
        key = fcitx::Key(value.toUtf8().constData());
...
private:
    fcitx::FcitxQtKeySequenceWidget *keyWidget_;
...
class EnumOptionWidget : public OptionWidget {
    Q_OBJECT
public:
    EnumOptionWidget(const fcitx::FcitxQtConfigOption &option, const QString &path,
                     QWidget *parent)
...
class ColorOptionWidget : public OptionWidget {
    Q_OBJECT
public:
    ColorOptionWidget(const fcitx::FcitxQtConfigOption &option, const QString &path,
                      QWidget *parent)
        : OptionWidget(path, parent), colorButton_(new QPushButton) {
        QVBoxLayout *layout = new QVBoxLayout;
        layout->setMargin(0);
...
class ExternalOptionWidget : public OptionWidget {
    Q_OBJECT
public:
    ExternalOptionWidget(const fcitx::FcitxQtConfigOption &option, const QString &path,
                         QWidget *parent)
        : OptionWidget(path, parent),
